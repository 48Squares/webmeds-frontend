        ...
        <div className="bg-gray-50 bg-opacity-8">
                ...
                <div className="px-2 py-2">
                    ...
                    <div className="flex items-center space-x-1">
                        <div
                            ...
                            <span className="inline-block text-white text-sm"> {product.rating}</span>
                        ...
                        <span className="text-xs text-gray-500">{product.rating_count} ratings</span>
                    </div>
            ...
            <div className="my-2 bg-white">
                <div className="px-2 py-2">
                    ...
                    <p className="text-sm">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque laborum minus mollitia
                        ut? Aut corporis inventore magni perferendis suscipit, voluptas. Deleniti iste maiores
                        molestias officia repellendus. Cumque nesciunt nostrum velit?
                    </p>
                </div>
            </div>
            ...
            <div className="flex">
                <button
                    className="bg-white flex-grow py-3 px-2 text-sm  uppercase text-gray-900 border-b border-t">Add
                    to Cart
                </button>

                <button
                    className="flex-grow py-3 px-2 text-sm  uppercase text-white  bg-yellow-500 border-b border-t">Buy
                    Now
                </button>
            </div>
        </div>
...
export async function getStaticProps() {
    return {
        props: {
            product: {
                title: 'Wildcraft HypaShield W95 Reusable Outdoor Protection Respirator Black Large Mask',
                price: '190',
                original_price: '200',
                discount: '5',
                rating: '3.5',
