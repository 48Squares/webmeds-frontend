        ...
        <div className="bg-white mb-8">
            ...
            <div className="p-4 mb-8">
                <form className="relative">
                    <input
                        className="border border-gray-300 h-12 w-full px-4 rounded-sm mt-2 border-1 border-transparent focus:outline-none focus:ring-2 focus:ring-regal-blue focus:border-transparent"
                        type="text"
                    ...
                    <input
                        className=" border border-gray-300 h-12 w-full px-4 rounded-sm mt-4 border border-transparent focus:outline-none focus:ring-2 focus:ring-regal-blue focus:border-transparent"
                        type="text"
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button
                            className="flex items-center space-x-2 border-gray-300 h-12 text-sm bg-regal-blue text-white w-full px-2 rounded-sm mt-4 border border-transparent focus:outline-none focus:ring-2 focus:ring-regal-blue focus:border-transparent"
                            type="button"
                        >
                    ...
                    <div className="flex space-x-4">
                        <input
                            className="shadow-sm border border-gray-300 h-12 w-full px-4 rounded-sm mt-4 border border-transparent focus:outline-none focus:ring-2 focus:ring-regal-blue focus:border-transparent"
                            type="text"
