            ...
            <div className="h-auto w-72 bg-white  m-auto">
                <div className="h-56 w-100  flex">
                    <div className="h-56 w-50% border-r  ">
                        <img src={"/earphone.jpg"} className="mt-4 h-36" />
                        <spna className="mx-4">Roti Maker</spna><br />
                        <Link href="/">
                    ...
                    <div className="h-56 w-50% ">
                        <img src={"/bag.jpg"} className="h-36  mt-4" />
                        <a>         <span className="mx-6">Sling Bags</span></a>
                        <br />
                        <Link href="/">
                            <a>      <span className="text-green-400 mx-4">Mine 80% Off</span>
                            </a>
                        </Link>
                    </div>
                </div>
