export default function linkscreen() {
    return (
        <div className="p-3">
            ...
            <span className="inline-block py-4 text-sm">
                <h1><b>Webmeds Terms of Use</b></h1>
            </span>
            <span className="inline-block pb-2 text-sm"><strong>This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.

                </strong></span>
            <span className="inline-block py-2 text-sm">
                <strong>

                    This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name [www.Webmeds.com][www.Webmeds.com] (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”)
                    </strong>
            </span>
            <span className="inline-block py-2 text-sm">
                The Platform is owned by Webmeds Internet Private Limited a company incorporated under the Companies Act, 1956 with its registered office at Buildings Alyssa, Begonia & Clover, Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru – 560103, Karnataka, India and its branch offices at 2nd Floor, Block F (Flora), Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru-560103, Karnataka, India and; 447/C, 12th Main, 4th Block, Koramangala, Bengaluru-560034, Karnataka, India (hereinafter referred to as "Webmeds").
            </span>
            <span className="inline-block py-2 text-sm">
                Your use of the Platform and services and tools are governed by the following terms and conditions ("Terms of Use") as applicable to the Platform including the applicable policies which are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform, You shall be contracting with Webmeds Internet Private Limited and these terms and conditions including the policies constitute Your binding obligations, with Webmeds.
            </span>
            <span className="inline-block py-2 text-sm">
                For the purpose of these Terms of Use, wherever the context so requires "You" or "User" shall mean any natural or legal person who has agreed to become a buyer on the Platform by providing Registration Data while registering on the Platform as Registered User using the computer systems. Webmeds allows the User to surf the Platform or making purchases without registering on the Platform. The term "We", "Us", "Our" shall mean Webmeds Internet Private Limited.
            </span>
            <span className="inline-block py-2 text-sm">
            ...
            <span className="inline-block py-2 text-sm">
                You agree that Webmeds shall not be liable or responsible for the activities or consequences of use or misuse of any information that occurs under your Account in cases, including, where You have failed to update Your revised mobile phone number and/or e-mail address on the Website Platform.
            </span>
            <span className="inline-block py-2 text-sm">
            ...
            <span className="inline-block py-2 text-sm">
                The Platform is a platform that Users utilize to meet and interact with one another for their transactions. Webmeds is not and cannot be a party to or control in any manner any transaction between the Platform's Users.<br/>
            </span>
            <span className="inline-block py-2 text-sm">
             <b> Henceforward:</b>
            </span>
            ...
            <span className="inline-block py-2 text-sm">
                At no time shall Webmeds hold any right, title or interest over the products nor shall Flipkart have any obligations or liabilities in respect of such contract.


            </span>
            <span className="inline-block py-2 text-sm">
                Webmeds is not responsible for unsatisfactory or delayed performance of services or damages or delays as a result of products which are out of stock, unavailable or back ordered.
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Webmeds is not responsible to verify the correctness of the GSTIN and/or entity name provided by You and You shall be entirely responsible to provide the accurate details.
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Webmeds and Seller shall not entertain any request for any revision in the GST Invoice. Webmeds and Seller shall not be liable for Your default including for reasons associated with details provided by You.
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Webmeds will not be liable in case You are not able to avail input tax credit or if input tax credit is denied to You for any reason whatsoever.
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Webmeds has the right to not allow business purchases on the Platform to You if a fraudulent activity is identified.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <b>
                    Disclaimer:</b> Pricing on any product(s) as is reflected on the Platform may due to some technical issue, typographical error or product information published by seller may be incorrectly reflected and in such an event seller may cancel such your order(s).
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                 You release and indemnify Webmeds and/or any of its officers and representatives from any cost, damage, liability or other consequence of any of the actions of the Users of the Platform and specifically waive any claims that you may have in this behalf under any applicable law. Notwithstanding its reasonable efforts in that behalf, webmeds cannot take responsibility or control the information provided by other Users which is made available on the Platform. You may find other User's information to be offensive, harmful, inconsistent, inaccurate, or deceptive. Please use caution and practice safe trading when using the Platform.
            ...
            <span className="inline-block py-2 text-sm">
                (o) engages in commercial activities and/or sales without Our prior written consent such as contests, sweepstakes, barter, advertising and pyramid schemes, or the buying or selling of "virtual" products related to the Platform. Throughout this Terms of Use, Webmeds's prior written consent means a communication coming from Webmeds's Legal Department, specifically in response to Your request, and specifically addressing the activity or conduct for which You seek authorization;
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Webmeds shall have all the rights to take necessary action and claim damages that may occur due to your involvement/participation in any way on your own or through group/s of people, intentionally or unintentionally in DoS/DDoS (Distributed Denial of Services).
            ...
            <p className="py-2 text-sm">
                <b>Following products shall not be eligible for return or replacement:</b>
 ...
 <p className="py-2 text-sm">
            ...
            <p className="py-2 text-sm">
               <b> f.</b> Any damage/defect which are not covered under the manufacturer's warranty

            </p>
            <span className="inline-block py-2 text-sm">
               <b> g.</b> Any product that is returned without all original packaging and accessories, including the box, manufacturer's packaging if any, and all other items originally included with the product/s delivered;
            ...
            <p className="py-2 text-sm">
                ...
                <table className="border-separate border border-black ...">
                    <thead>
                        <tr>
                            <th className="border border-black ...">Default Restrictions</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="border border-black ...">Side-Loading (from one device to other)</td>
                            <td className="border border-black ...">Not Allowed</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td className="border border-black ...">Number of distinct devices for file downloading</td>
                            <td className="border border-black ...">Not Allowed</td>
                        </tr>
                        <tr>
            ...
            <span className="inline-block py-2 text-sm">
                Rights Granted: Upon your payment of our fees for ebook, we grant you a non-exclusive, non-transferable right to use the downloaded ebook for your personal, non-commercial, entertainment use, subject to and in accordance with the Terms of Use. You may store the ebook only for your personal, non-commercial, entertainment use, subject to and in accordance with the Terms of Use.
                 </span>
            <span className="inline-block py-2 text-sm">
                You represent, warrant and agree that you will use the ebook only for your personal, non-commercial, entertainment use and not for any redistribution of the same or other use restricted in this Section. You agree not to infringe the rights of the copyright owners and to comply with all applicable laws in your use of the ebook. You agree that you will not redistribute, transmit, assign, sell, broadcast, rent, share, lend, modify, adapt, edit, license or otherwise transfer or use ebook.

            </span>
            <span className="inline-block py-2 text-sm">
                You are not granted any synchronization, public performance, promotional use, commercial sale, resale, reproduction or distribution rights for ebook. You acknowledge that the ebook embodies the intellectual property of a third party and is protected by law.

            </span>
            <span className="inline-block py-2 text-sm">
                Explicit Consent: You agree that we shall have no liability to you for ebook downloaded by You on the Platform or Flyte Apps if you find the same to be offensive, indecent or objectionable.

            </span>
            <span className="inline-block py-2 text-sm">
               <b> Payment:</b> The Price List for each downloadable ebook displayed on the Platform represents the full retail price (inclusive of all taxes unless specified otherwise) for said downloadable ebook. You shall pay for such downloadable ebook using one of the payment options available on the Platform.

            </span>
            <span className="inline-block py-2 text-sm">
                The Price List mentions the prices of each downloadable ebook and the User shall pay in Indian Currency (i.e. Indian Rupee). We reserve our right to change the prices of the ebook and services and the availability of the same at our sole discretion.
            </span>
            <p className="py-2 text-sm">
               Webmeds will allow the user to buy ebook using the following forms of payments.
            ...
            <p className="inline-block py-2 text-sm">
             ...
             <li> Credit Cards</li>
                ...
                <li>any other mode of payment, as may be decided and made available on the Platform.</li>
            ...
            <span className="inline-block py-2 text-sm">
                Cash on Delivery as a mode of payment is not available for purchasing ebook on the Platform currently.
            ...
            <span className="inline-block py-2 text-sm">
                Intellectual Property Rights: It is hereby specifically recorded that the copyright and other Intellectual Property in the ebook available on the Platform is the sole and exclusive property of third parties. We are authorised by such third parties to upload the ebook on the Platform for license of use to the end customers. Intellectual Property Rights for the purpose of this Agreement shall always mean and include copyrights whether registered or not, patents including rights of filing patents, trademarks, trade names, trade dresses, house marks, collective marks, associate marks and the right to register them, designs both industrial and layout, geographical indicators, moral rights, broadcasting rights, displaying rights, distribution rights, selling rights, abridged rights, translating rights, reproducing rights, performing rights, communicating rights, adapting rights, circulating rights, protected rights, joint rights, reciprocating rights, infringement rights. All those Intellectual Property rights arising as a result of domain names, internet or any other right available under applicable law shall vest in the domain of Flipkart Internet Private Limited as the owner of such domain name. The Parties hereto agree and confirm that no part of any Intellectual Property rights mentioned hereinabove is transferred in the name of User and any intellectual property rights arising as a result of these presents shall also be in the absolute ownership, possession and our control or control of its licensors, as the case may be.
            ...
            <span className="inline-block py-2 text-sm">
                <b>Software:</b> We may make available to you, from time to time, software or updates for your use in connection with the download of eBooks (any and all such software, individually and collectively, the "Software").

            </span>
            <span className="inline-block py-2 text-sm">
                You may use the Software only in connection with the download of eBooks on the Platform. You may not separate any individual component of the Software for use other than in connection to the download, may not incorporate any portion of it into Your own programs or compile any portion of it in combination with your own programs, may not transfer it for use with another service, or use it, or any portion of it, over a network and may not sell, rent, lease, lend, loan, distribute or sub-license the Software or otherwise assign any rights to the Software in whole or in part. We may discontinue some or all of any Software we provide, and we may terminate your right to use any Software at any time and in such event may modify it to make it inoperable.
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    These Terms of Service (“Terms”) govern your access to and use of Webmeds Ideas (hereinafter referred to as “Content”). By viewing the Contents you agree to be bound by these Terms. Content posted on the Platform is public and can be viewed by everyone who can see the Page.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Webmeds is hosting the Content generated by third party users (“Content Owner”), within the FK Platform for convenience of Platform Users, and as such,Webmeds has no ownership or control whatsoever in the Contents displayed. The Contents posted by the Content Owners are of personal views wherein Flipkart plays no role in creating/developing the Content. You are responsible for your use of the Platform for viewing the Content.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                By hosting the Content on the Platform, Webmeds is neither guaranteeing nor giving any warranty nor making any representation with respect to the Contents. Webmeds is neither endorsing the views, products or the Services, nor is it responsible for quality or features of the content displayed on the Platform.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Any information on the Platform, whether the content or any other information, have not been verified by Webmeds, therefore, Webmeds shall not be responsible for any such content or information. Webmeds will not bear any obligation or liability if You rely on the Contents.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Any information on the Platform, whether the content or any other information, have not been verified by Flipkart, therefore, Flipkart shall not be responsible for any such content or information. Flipkart will not bear any obligation or liability if You rely on the Contents.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    You hereby acknowledge that the Contents are created and owned by Content Owners who own all the rights including the copyrights in the contents. The Contents are available on the Platform for personal use only and you shall not use it for any commercial, promotional, resale or further distribution purposes.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    We reserve the right to remove Content that violates the Terms of Use, including for example, copyright or trademark violations, impersonation, unlawful conduct, or harassment.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                If you see an offensive, abusive, or any unlawful content on the Platform, you can report it to ideas-support@flipkart.com
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    You may find content that offends you or that you simply don’t like, but that doesn’t violate the content guidelines. If that happens, you can unfollow the user who posted it or hide the post
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    Your access to and use of the Services or any Content are at your own risk. You understand and agree that the Services are provided to you on an “AS IS” and “AS AVAILABLE” basis. Flipkart makes no warranty or representation and disclaim all responsibility and liability for: (i) the completeness, accuracy, availability, timeliness, security or reliability of any Content; (ii) any harm to your computer system, loss of data, or other harm that results from your access to or use of any Content; (iii) the deletion of, or the failure to store or to transmit, any Content and other communications maintained by the Services; and (iv) whether the Services will meet your requirements or be available on an uninterrupted, secure, or error-free basis. No advice or information, whether oral or written, obtained through the Content, will create any warranty or representation not expressly made herein.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    By using the Services you agree that Flipkart, its parents, affiliates, related companies, officers, directors, employees, agents representatives, partners and licensors, liability is limited to the maximum extent permissible by Law.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    These Terms of Service ("Terms") govern your access to and use of Webmeds Video which is an online over-the-top platform providing users with live and/or on-demand audio and video content of various genres which may be offered by either Flipkart or by third party content providers (all such content, collectively, the "Content").
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    The Content is being hosted on Webmeds mobile App only ("Platform"), that is owned and operated by Webmeds Internet Private Limited ("Flipkart", "We" or "Our").
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    If you see an offensive, abusive, or any unlawful content on the Platform, you can report it to customer care of Webmeds.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                <li>
                    <b>Severability:</b> If any provision of these Terms is held invalid, void, or unenforceable, then that provision shall be considered severable from the remaining provisions, and the remaining provisions shall be given full force and effect.
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                Webmeds we do not warrant that Product description or other content of this Platform is accurate, complete, reliable, current, or error-free and assumes no liability in this regard.
            ...
            <span className="inline-block py-2 text-sm">
                Webmeds prohibits the use of language that is racist, hateful, sexual or obscene in nature in a public area.
            ...
            <span className="inline-block py-2 text-sm">
                Webmeds will consider the circumstances of an alleged policy violation and the user's trading records before taking action.
            ...
            <span className="inline-block py-2 text-sm">
                Webmeds shall have the right to delete a product review posted by the customer at its sole discretion, if it is of the opinion that the review contains offensive language as stated above. Further, if Flipkart is of the opinion that the review unfairly either: (i) causes disadvantage to a product; or (ii) increases the popularity of the product, Flipkart shall have the right to delete the customer review. Webmeds shall also, at its sole discretion have the right to blacklist the customer from posting any further customer reviews.
            ...
            <span className="inline-block py-2 text-sm">
               <b> Definition:</b> 'Return' is defined as the action of giving back the item purchased by the Buyer to the Seller on the Flipkart Platform. Following situations may arise:
            ...
            <span className="inline-block py-2 text-sm">
               ...
               <p> Further for returns being made by Buyer to the Seller of the product, the following parameters needs to be ensured by the Buyer:
                </p>
                </span>
            ...
            <p className="py-2 text-sm">
                ...
                <table className="border-collapse border border-black ...">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="border border-black ...">Clothing and Footwear</td>
                            <td className="border border-black ...">Should be "New & Unworn" (other than for trial)</td>
                        </tr>
                       
                        <tr>
                            <td className="border border-black ...">Sports & Equipment</td>
                            <td className="border border-black ...">Should be "New" and returned with original packaging</td>
                        </tr>
                        <tr>
            ...
            <span className="inline-block py-2 text-sm">
                Shipping cost for returning the product shall be borne and incurred by the Seller.Shipping cost for returning the product shall be borne and incurred by the Seller.
            ...
            <p className="py-2 text-sm">
                <b>Definition:</b> Replacement is the action or process of replacing something in place of another. A Buyer can request for replacement whenever he is not happy with the item, reason being Damaged in shipping, Defective item, Item(s) missing, wrong item shipped and the like.
            ...
            <p className="py-2 text-sm">
                <li>Incase Seller rejects the replacement request, Buyer can choose to raise a dispute by writing to </li>
                <a href="https://www.Webmeds.com/helpcenter" className="no-underline hover:underline ...">https://www.Webmeds.com/helpcenter</a>
            ...
            <span className="inline-block py-2 text-sm">
                Generally, transactions are conducted smoothly on Webmeds. However there may be some cases where both the Buyers and Sellers may face issues. At Flipkart, we have a Dispute Resolution process in order to resolve disputes between Buyers and Sellers.
            ...
            <p className="py-2 text-sm">
                Whenever there is a disagreement, the Buyer can write to  <a href="https://www.Webmeds.com/helpcenter" className="no-underline hover:underline ...">https://www.Webmeds.com/helpcenter</a>
 , while the Seller can write to ss@flipkart.com, in order to raise a dispute. Disputes can be raised at a particular transaction level.
            ...
            <span className="inline-block py-2 text-sm">
                The Buyer can write to  <a href="https://www.Webmeds.com/helpcenter" className="no-underline hover:underline ...">https://www.Webmeds.com/helpcenter</a>
 ,if the issue with the Seller is not resolved. Flipkart's Customer Support team will look into the case to check for possible fraud and if the Buyer has been blacklisted/blocked from making purchases on the Platform. Only after verifying these facts, a dispute can be registered.
            ...
            <p className="py-2 text-sm">
                To be able to take advantage of the Buyer Protection Program, Buyers should first contact the Seller and attempt to resolve the issue. If the Buyer doesn't hear from the Seller or is unable to resolve the issue with the Seller even after contact, a dispute can be raised with Flipkart by writing an email to<br/>
                <a href="https://www.Webmeds.com/helpcenter" className="no-underline hover:underline ...">https://www.Webmeds.com/helpcenter</a>
            ...
            <span className="inline-block py-2 text-sm">
                Buyers who have reached their maximum lifetime limit for claims are also not eligible. Buyers can make a maximum of 5 claims per year on Flipkart. If the claim was withdrawn, it is not counted. The coverage amount will be limited to â‚¹50,000

            </span>
            <span className="inline-block py-2 text-sm">
                Through the Buyer Protection program, Webmeds does not provide any guarantee/warranty to Buyers for products sold on Webmeds against technical/manufacturing defects.
            ...
            <span className="inline-block py-2 text-sm">
               Webmeds shall at no point be responsible for any direct or indirect losses, expenses, costs of any nature whatsoever that may be incurred by any Buyer/Seller.
            ...
            <span className="inline-block py-2 text-sm">
                Decisions made by Webmeds under the Buyer Protection Program shall be final and binding on its Users.

            </span>
            <span className="inline-block py-2 text-sm">
                Webmeds reserves the right to modify / discontinue Buyer Protection Program without any prior notice period to its Users.
            </span>
            <span className="inline-block py-2 text-sm">
                Through this program,Webmeds shall not entertain claims of Buyers who have incurred loss due to delayed shipment or delivery of the item by the Seller.

            </span>
            <span className="inline-block py-2 text-sm">
               Webmeds Customer Support Team may seek additional information / clarification from Buyer to facilitate resolution of the dispute. In the event Buyer does not respond with information / clarification sought within 10 days of such request, the dispute shall be auto-closed in favour of the Seller.
            ...
            <span className="inline-block py-2 text-sm">
                Private communication, including email correspondence, is not regulated by Webmeds. Webmeds encourages its Users to be professional, courteous and respectful when communicating by email.

            </span>
            <span className="inline-block py-2 text-sm">
                However, Webmeds will investigate and can take action on certain types of unwanted emails that violate Webmeds policies.
            ...
            <span className="inline-block py-2 text-sm">
                Threats of Bodily Harm - Webmeds does not permit Users to send explicit threats of bodily harm.

            </span>
            <span className="inline-block py-2 text-sm">
                Misuse of Webmeds System - Webmeds allows Users to facilitate transactions through the Webmeds system, but will investigate any misuse of this service.

            </span>
            <span className="inline-block py-2 text-sm">
                Spoof (Fake) email - Webmeds will never ask you to provide sensitive information through email. In case you receive any spoof (fake) email, you are requested to report the same to Us through 'Contact Us' tab.

            </span>
            <span className="inline-block py-2 text-sm">
                Spam (Unsolicited Commercial email) - Webmeds spam policy applies only to unsolicited commercial messages sent by Webmeds Users. Webmeds Users are not allowed to send spam messages to other Users.

            </span>
            <span className="inline-block py-2 text-sm">
                Offers to Buy or Sell Outside of Webmeds - Webmeds prohibits email offers to buy or sell listed products outside of the Webmeds Platform. Offers of this nature are a potential fraud risk for both Buyers and Sellers.

            </span>
            <span className="inline-block py-2 text-sm">
               Webmeds policy prohibits user-to-user threats of physical harm via any method including, phone, email and on Our public message boards.

            </span>
            <p className="py-2 text-sm">
               <b> Violations of this policy may result in a range of actions, including:</b>
            ...
            <span className="inline-block py-2 text-sm">
                Webmeds has put in place Webmeds Infringement Verification process so that intellectual property owners could easily report listings that infringe their rights. It is in Webmeds interest to ensure that infringing products are removed from the site, as they erode Buyer and good Seller trust.

            </span>
            <span className="inline-block py-2 text-sm">
                <li>
                    If you are a Verified Rights Owner and want to report a listing issue, see Webmeds FIV. Note: Only the intellectual property rights owner can report potentially infringing products or listings through FIV. If you are not the intellectual property rights owner, you can still help by getting in touch with the rights owner and encouraging them to [contact us][].
                </li>
            ...
            <span className="inline-block py-2 text-sm">
               Webmeds does not and cannot verify that Sellers have the right or ability to sell or distribute their listed products. However, Flipkart is committed to removing infringing or unlicensed products once an authorized representative of the rights owner properly reports them to Webmeds.
            ...
            <span className="inline-block py-2 text-sm">
                <b>Program membership entitles you (Verified Rights Owner) to the following benefits:</b>

            </span>
            <p className="py-2 text-sm">
                <li>
                    Rapid response by Webmeds in ending listings reported by you (as the Verified Rights Owner) as allegedly infringing
                </li>
            ...
            <span className="inline-block py-2 text-sm">
                In the interest of keeping the process easy and simple, after we receive your first Notice of Infringement in hard copy, future notices can be sent to Us by email at ss@Webmeds.com.

            </span>
            <span className="inline-block py-2 text-sm">
                <b>Note:</b> In your notice of infringement, you shall be required to identify the individual listing which is infringing your intellectual property. General notices shall not be accepted.
            ...
            <p className="py-2 text-sm">
                At Flipkart we are committed towards ensuring that disputes between sellers and buyers are settled amicably by way of the above dispute resolution mechanisms and procedures. However, in the event that a buyer wishes to contact the seller, he/ she may proceed to do so by accessing the seller related information made available by the sellers on their product listing pages. Alternatively, the buyers may also reach out to customer support at 1800 208 9898 or access help center at
                <a href="https://www.Webmeds.com/helpcenter" className="no-underline hover:underline ...">https://www.Webmeds.com/helpcenter</a>
