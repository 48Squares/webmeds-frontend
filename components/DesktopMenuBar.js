...
function MegaMenu() {
    return <div className="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-blue-800 z-10">
        <div className="container mx-auto w-full flex flex-wrap justify-between mx-2">
            ...
            <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                ...
                <p className="text-gray-100 text-sm">Quarterly sales are at an all-time low
                    create spaces to explore the accountable talk and blind vampires.</p>
                <div className="flex items-center py-3">
                    ...
                    <a href="#"
                       className="text-white bold border-b-2 border-blue-300 hover:text-blue-300">Find
                        out more...</a>
                </div>
            </ul>
            <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                ...
                <p className="text-gray-100 text-sm">Prioritize these line items game-plan draw
                    a line in the sand come up with something buzzworthy UX upstream
                    selling.</p>
                <div className="flex items-center py-3">
                    <svg className="h-6 pr-3 fill-current text-blue-300"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-b-0 sm:border-r md:border-b-0 pb-6 pt-6 lg:pt-3">
                ...
                <p className="text-gray-100 text-sm">This proposal is a win-win situation which
                    will cause a stellar paradigm shift, let's touch base off-line before we
                    fire the new ux experience.</p>
                <div className="flex items-center py-3">
                    <svg className="h-6 pr-3 fill-current text-blue-300"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
            ...
            <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 pb-6 pt-6 lg:pt-3">
                ...
                <p className="text-gray-100 text-sm">This is a no-brainer to wash your face, or
                    we need to future-proof this high performance keywords granularity.</p>
                <div className="flex items-center py-3">
                    <svg className="h-6 pr-3 fill-current text-blue-300"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="text-sm text-gray-800 font-medium leading-none">
                            <button className="flex items-center"
                                    onMouseEnter={() => this.setState({showMegaMenu: !this.state.showMegaMenu})}>
                                <span>Top Offers</span>

                                <svg className="text-gray-400 h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                            ...
                            {this.state.showMegaMenu ? <MegaMenu/> : null}
                        </div>
                    </div>
