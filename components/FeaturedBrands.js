...
function PlaceholderShell() {
  return (
    <div className="p-4 h-48 animate-pulse flex space-x-4">
      <div className="flex flex-col justify-center items-center">
        <div className="bg-gray-100 w-48 h-full">&nbsp;</div>
    ...
    return (
      <div className="bg-white py-2 mt-2 shadow">
        ...
        <div className="w-full p-4">
          <Swiper slidesPerView={6} navigation pagination={{ clickable: true }}>
